...
cluster <- read_xlsx("~/../OneDrive/Downloads/FedRes0.2MarkerGenesCluster28_20230605.xlsx", sheet = "cluster28_0.markers")
...
write_xlsx(cluster, "cluster28_0_TaylorL4Markers.xlsx")
...
write_xlsx(temp, "cluster28_0_GradingTaylorL4.xlsx")
