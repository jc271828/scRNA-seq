...
cluster <- read_xlsx("~/../OneDrive/Downloads/FedRes0.2MarkerGenesCluster20_20230605.xlsx", sheet = "cluster20_3.markers")
...
write_xlsx(cluster, "cluster20_3_TaylorL4Markers.xlsx")
...
write_xlsx(temp, "cluster20_3_GradingTaylorL4.xlsx")
